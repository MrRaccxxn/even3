        ...
        <Container >
            <div className="text-left">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Even3.</p>
                    </li>
                    <li>
                        <p><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
                    </li>
                    <li>
                        <p><strong>Country</strong> refers to:  Bolivia</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Even3, accessible from <a href="https://even3.vercel.app/" rel="external nofollow noopener" target="_blank">https://even3.vercel.app/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: even3.contact@gmail.com</li>
                </ul>
            </div>
        </Container >
    </Layout>
